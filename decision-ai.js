...
返回结构：{"risk_level":"S1或S2","question_summary":"一句话总结","options":[{"title":"简洁具体的选项","may_satisfy":["需求1","需求2","需求3"]},{"title":"选项2","may_satisfy":["需求1","需求2","需求3"]}],"criteria":["标准1","标准2","标准3"],"third_route":{"title":"第三条路短标题","description":"具体、低成本、可执行的折中或补信息策略"}}
options 保持 2-3 个；may_satisfy 描述主观需要，不能把低卡、健康、便宜等未确认信息写成事实。`,
    `用户问题：${question}`,
    0.35,
  );
}
